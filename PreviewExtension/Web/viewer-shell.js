    ...
    app.insertAdjacentHTML('afterend', `
      <div id="buret-toolbar" role="toolbar" aria-label="Burette preview controls">
        <div class="buret-toolbar-content" data-buret-toolbar-content>
          ...
          <button class="buret-button buret-assembly-symmetry hidden" type="button" data-buret-action="assembly-symmetry" aria-label="Show assembly symmetry axes" aria-pressed="false" title="Show assembly symmetry axes">
            Symmetry<span class="buret-tooltip" role="tooltip">Show assembly symmetry axes</span>
          </button>

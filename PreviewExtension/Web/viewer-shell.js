          ...
          <details class="buret-xyzrender-advanced" data-buret-xyzrender-field>
            ...
            <div class="buret-xyzrender-section buret-xyzrender-section-advanced">
              <div class="buret-field-grid">
                ...
                <label class="buret-field"><span>Iso</span><span class="buret-slider-row"><input class="buret-slider" type="range" min="0" max="2" step="0.01" value="0.3" data-buret-xctrl-slider="fieldIso" /><input class="buret-input buret-slider-value" type="number" min="0" step="0.01" placeholder="auto" data-buret-xctrl="fieldIso" /></span></label>

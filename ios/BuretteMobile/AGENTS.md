# BuretteMobile Agent Instructions

## Scope

These rules apply to `ios/BuretteMobile/**` and changes that affect the
source-built iPhone preview app target.

## Required Context

- Read `ios/BuretteMobile/README.md` before changing the mobile target.
...
- Do not change `BuretteMobile` scheme, target wiring, document type
  registrations, or bundled preview asset paths without updating
  `ios/BuretteMobile/README.md`.

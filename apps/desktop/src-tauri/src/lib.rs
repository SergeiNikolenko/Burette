...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            compute::commands::compute_execute_learned_chemical_space,
            ...
            commands::descriptors::descriptor_runtime_cancel_install,
            commands::chemical_space_models::chemical_space_model_runtime_status,
            commands::chemical_space_models::chemical_space_model_runtime_install,
            commands::chemical_space_models::chemical_space_model_runtime_cancel_install,
            commands::chemical_space_models::chemical_space_represent_start,
            commands::chemical_space_models::chemical_space_represent_status,
            commands::chemical_space_models::chemical_space_represent_cancel,
            commands::derived::derived_source_rows,
            ...
            commands::database::database_store_secret,
            commands::database::database_secret_status,
            commands::database::database_forget_secret,

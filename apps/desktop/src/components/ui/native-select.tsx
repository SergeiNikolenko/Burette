...
import { ChevronUpDown as UnfoldMoreIcon } from "@/components/ui/app-icon-data";
...
function NativeSelect({
  ...
  return (
    <div
      className={cn(
        "group/native-select relative w-fit has-[select:disabled]:opacity-[var(--shadcn-disabled-opacity)]",
        className
      )}

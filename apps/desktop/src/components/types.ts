...
export type ShellActions = {
  ...
  openStructureRecords: (records: StructureDragPayload["records"], directory?: string) => void | Promise<void>;
  ...
  openNewWindow: (paths?: string[]) => void | Promise<void>;
  openSettings: () => void;
  ...
  closeTabs: (ids: string[]) => void | Promise<void>;

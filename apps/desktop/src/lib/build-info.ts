...
function buildInfoFromValues(
  ...
  return {
    ...
    notes: isDevBuild
      ? [isAgentShell ? "Visualization and chemical editing; no molecular compute" : "Full desktop features", isAgentShell ? "Agent browser shell" : isBrowserDev ? "Vite browser runtime" : "Isolated app and Quick Look identifiers"]
      : [],

...
function looksLikeStructurePathLine(line: string) {
  ...
  return /\.(?:abi|arc|bcif|ccp4|cif|cms|com|cub|cube|csv|dwar|ent|fdf|gro|in|inp|log|mae|maegz|map|mcif|mmcif|mol|mol2|mrc|mtz|nw|out|pdb|pdbqt|ph4|pqr|psi4|qcin|sd|sdf|smi|smiles|tsv|vasp|xyz)$/iu.test(line);
}

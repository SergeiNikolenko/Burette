---
name: burrete-release-readiness
description: Review Burrete release readiness for versioning, packaging, signing, updates, installers, and package managers.
---
...
- Package managers:
  - external Homebrew tap `SergeiNikolenko/homebrew-burrete`
  - `HOMEBREW_TAP_TOKEN`
  - cask `version` and `sha256`
  - Bun package under `packages/burrete`

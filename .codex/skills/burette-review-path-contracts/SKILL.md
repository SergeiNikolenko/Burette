---
name: burette-review-path-contracts
description: Review path, URL, file, and session-directory handling across Burette boundaries.
---
...
- Keep `BURETTE_DEV_FS_ALLOW` explicit for browser-dev access outside the repo.

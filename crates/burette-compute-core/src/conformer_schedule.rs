...
//!
//! This module was implemented independently from Burette's execution and
//! reproducibility contracts. It does not copy or adapt `mlxmolkit` source.

use std::{error::Error, fmt, mem::size_of, num::NonZeroU32};

use burette_compute_protocol::{ConformerVariant, MAX_COMPUTE_MEMORY_BYTES};
use sha2::{Digest, Sha256};

const SEED_DOMAIN: &[u8] = b"burette.conformer-seed.v1\0";

...
const ENTRYPOINTS: [&str; 24] = [
    "burette_tanimoto_degree_count_v1",
    "burette_tanimoto_csr_fill_v1",
    "burette_tanimoto_query_counts_v1",
    "burette_tanimoto_counts_batch_v1",
    "burette_tanimoto_top_k_batch_v1",
    "burette_conformer_initialize_v1",
    "burette_conformer_distance_v1",
    "burette_conformer_optimize_v1",
    "burette_conformer_stereo_validate_v1",
    "burette_conformer_etk_v1",
    "burette_conformer_etk_optimize_v1",
    "burette_mmff_energy_v1",
    "burette_mmff_analytic_gradient_v1",
    "burette_mmff_optimize_v1",
    "burette_alignment_score_v1",
...
pub fn verify_runtime_package(root: &Path) -> Result<VerifiedMetalPackage, MetalRuntimeError> {
    ...
    if pointer.schema_version != "burette.compute.metal-generation-pointer.v1" {
...
fn validate_metadata(metadata: &BuildMetadata) -> Result<(), MetalRuntimeError> {
    ...
    if metadata.schema_version != "burette.compute.metal-build-metadata.v2"
        || metadata.runtime_version != NATIVE_METAL_RUNTIME_VERSION
        || metadata.library_id != "burette.compute.native.v22"
...
mod tests {
    ...
    impl RuntimeFixture {
        ...
        fn write_pointer(&self, generation: &str, metadata_sha256: &str) {
            let pointer = json!({
                "schemaVersion": "burette.compute.metal-generation-pointer.v1",
        ...
        fn metadata(&self, metallib: &[u8]) -> serde_json::Value {
            ...
            json!({
                "schemaVersion": "burette.compute.metal-build-metadata.v2",
                "runtimeVersion": NATIVE_METAL_RUNTIME_VERSION,
                "libraryId": "burette.compute.native.v22",

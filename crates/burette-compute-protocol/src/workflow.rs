...
pub enum ComputeJobSchemaVersion {
    #[serde(rename = "burette.compute-job.v1")]
    V1,
}
...
mod tests {
    ...
    fn canonical_request_bytes_and_hash_are_pinned() {
        ...
        let declaration_order_json = concat!(
            r#"{"schemaVersion":"burette.compute-job.v1","workflowTemplate":"cluster.v1","source":{"documentId":"document-1","scope":{"kind":"selected","sourceIndexes":[2,7]}},"#,

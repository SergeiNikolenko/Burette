...
const AM1: [SemiempiricalElementParameters; 4] = [
    element(1, "H", 1, [-11.396427, 0.0, 1.188078, 0.0, -6.173787, 0.0],
        [12.848, 0.0, 0.0, 0.0, 0.0, 2.882324],
        [[0.122796, 5.0, 1.2], [0.005090, 5.0, 1.8], [-0.018336, 2.0, 2.1], [0.0; 3]]),
    element(6, "C", 4, [-52.028658, -39.614239, 1.808665, 1.685116, -15.715783, -7.719283],
        [12.23, 11.47, 11.08, 9.84, 2.43, 2.648274],
        [[0.011355, 5.0, 1.6], [0.045924, 5.0, 1.85], [-0.020061, 5.0, 2.05], [-0.001260, 5.0, 2.65]]),
    element(7, "N", 5, [-71.86, -57.167581, 2.315410, 2.157940, -20.299110, -18.238666],
        [13.59, 12.66, 12.98, 11.59, 3.14, 2.947286],
        [[0.025251, 5.0, 1.5], [0.028953, 5.0, 2.1], [-0.005806, 2.0, 2.4], [0.0; 3]]),
    element(8, "O", 6, [-97.83, -78.262380, 3.108032, 2.524039, -29.272773, -29.272773],
        [15.42, 14.48, 14.52, 12.98, 3.94, 4.455371],
        [[0.280962, 5.0, 0.847918], [0.081430, 7.0, 1.445071], [0.0; 3], [0.0; 3]]),
];

const PM3: [SemiempiricalElementParameters; 4] = [
    element(1, "H", 1, [-13.073321, 0.0, 0.967807, 0.0, -5.626512, 0.0],
        [14.794208, 0.0, 0.0, 0.0, 0.0, 3.356386],
        [[1.12875, 5.096282, 1.537465], [-1.060329, 6.003788, 1.570189], [0.0; 3], [0.0; 3]]),
    element(6, "C", 4, [-47.27032, -36.266918, 1.565085, 1.842345, -11.910015, -9.802755],
        [11.200708, 10.265027, 10.796292, 9.042566, 2.29098, 2.707807],
        [[0.050107, 6.003165, 1.642214], [0.050733, 6.002979, 0.892488], [0.0; 3], [0.0; 3]]),
    element(7, "N", 5, [-49.335672, -47.509736, 2.028094, 2.313728, -14.062521, -20.043848],
        [11.904787, 7.348565, 11.754672, 10.807277, 1.136713, 2.830545],
        [[1.501674, 5.901148, 1.71074], [-1.505772, 6.004658, 1.716149], [0.0; 3], [0.0; 3]]),
    element(8, "O", 6, [-86.993002, -71.87958, 3.796544, 2.389402, -45.202651, -24.752515],
        [15.75576, 10.62116, 13.654016, 12.406095, 0.593883, 3.217102],
        [[-1.131128, 6.002477, 1.607311], [1.137891, 5.950512, 1.598395], [0.0; 3], [0.0; 3]]),
];

const PM6_SP: [SemiempiricalElementParameters; 4] = [
    element(1, "H", 1, [-11.24696, 0.0, 1.26864, 0.0, -8.35298, 0.0],
        [14.44869, 0.0, 0.0, 0.0, 0.0, 3.35639],
        [[0.024184, 3.055953, 1.786011], [0.0; 3], [0.0; 3], [0.0; 3]]),
    element(6, "C", 4, [-51.08965, -39.93792, 2.04756, 1.70284, -15.38524, -7.47193],
        [13.33552, 11.52813, 10.77833, 9.48621, 0.71732, 2.70781],
        [[0.0463, 2.10021, 1.33396], [0.0; 3], [0.0; 3], [0.0; 3]]),
    element(7, "N", 5, [-57.78482, -49.89304, 2.38041, 1.99925, -17.97938, -15.05502],
        [12.35703, 9.63619, 12.57076, 10.57643, 2.87154, 2.83054],
        [[-0.001436, 0.495196, 1.704857], [0.0; 3], [0.0; 3], [0.0; 3]]),
    element(8, "O", 6, [-91.67876, -70.46095, 5.42175, 2.27096, -65.63514, -21.6226],
...
const AM1_STAR: [SemiempiricalElementParameters; 4] = [
    element(1, "H", 1, [-11.2709, 0.0, 1.169675, 0.0, -5.93954, 0.0],
        [12.848, 0.0, 0.0, 0.0, 0.0, 2.65747],
        [[3.844408, 4.793111, 1.452021], [1.315199, 5.778936, 1.867145], [-4.36017, 3.499363, 1.540349], [0.0; 3]]),
    element(6, "C", 4, [-51.7812, -39.9628, 1.6352, 1.733751, -11.5065, -9.19868],
        [12.23, 11.47, 11.08, 9.84, 2.43, 2.712553],
        [[0.05463, 7.312193, 1.700631], [-0.07112, 10.37091, 2.516281], [0.07237, 12.12756, 2.507685], [-0.00307, 24.36623, 3.511127]]),
    element(7, "N", 5, [-66.567, -57.3715, 2.469507, 2.033593, -15.8169, -16.7438],
        [13.59, 12.66, 12.98, 11.59, 3.14, 3.097823],
        [[0.084117, 2.288517, 1.217317], [0.436119, 39.64693, 2.414354], [-0.4254, 38.46668, 2.414079], [0.0; 3]]),
    element(8, "O", 6, [-82.4869, -78.643, 11.81357, 2.438453, -150.235, -26.3035],
        [15.42, 14.48, 14.52, 12.98, 3.94, 3.311738],
        [[-0.03582, 26.29376, 0.822597], [0.008038, 155.0571, 1.33939], [0.0; 3], [0.0; 3]]),
];

...
pub use runtime::{
    ...
    MetalDistanceEvaluation, MetalDistanceOptimization, MetalGraphExecution, MetalQueryExecution,
    MetalStereoValidation, MetalTanimotoRuntime,
};

pub const NATIVE_METAL_RUNTIME_VERSION: &str = "burrete-native-metal-v6";

...
Native operating-system file-pane registration and public-directory acceptance
remain separate capabilities, not implied by MCP App support. Finder/Open With
uses explicit authorized file actions through the local plugin. See

...
assert.match(toolbar, /preferences\.theme === "auto" \? "light" : preferences\.theme === "light" \? "dark" : "auto"/);
assert.match(toolbar, /aria-label=\{themeLabel\}/);
assert.match(toolbar, /<ColorTheme size=\{17\} aria-hidden="true" \/>/);

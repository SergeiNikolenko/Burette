...
panelHeight = 88;
sync();
assert.equal(reading.scrollTop, 0, 'compact mode cannot remain scrolled down to water');
...
storedHeight = 'NaN';
initResize();
assert.equal(resizeOptions.initialHeight, 88, 'invalid stored values fall back to the single-line default');

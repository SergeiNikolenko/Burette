...
assert.match(viewer, /'Align all to this'/);
assert.match(viewer, /referenceId: moving\.id, movingIds: references\.map\(reference => reference\.id\)/);
assert.match(viewer, /\), 'TM-align'\]/);

...
assert.match(viewer, /function requestHostXyzrenderSheetItem\(path, preset, controls\)/);
...
assert.match(browserDevDocuments, /const GRID_ASSET_VERSION = "grid-ui-v55"/);
assert.match(browserDevDocuments, /const VIEWER_ASSET_VERSION = "viewer-ui-v11"/);

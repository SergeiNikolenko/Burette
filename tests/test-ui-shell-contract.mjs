...
assert.match(previewViewer, /\{ id: 'analyze', title: 'Analyze', rootLabel: 'Tools', breakBefore: true, dialog: true \}/);
assert.match(previewViewer, /\{ id: 'export', title: 'Export', dialog: true \}/);
assert.match(previewViewer, /function createMoleculeToolDialog\(titleText, subtitleText, options = \{\}\)/);
assert.match(previewViewer, /panel\.setAttribute\('role', 'dialog'\)/);
assert.match(previewViewer, /panel\.setAttribute\('aria-modal', 'true'\)/);
assert.match(previewViewer, /panel\.setAttribute\('aria-labelledby', title\.id\)/);
assert.match(previewViewer, /function showMoleculeActionDialog\(section, entries, target, previousFocus\)/);
assert.match(previewViewer, /function moleculeMenuDialogTrigger\(section, entries, menu, target\)/);
assert.match(previewViewer, /if \(section\.dialog\) \{[\s\S]*moleculeMenuDialogTrigger\(section, entries, menu, actionTarget\)/);
assert.match(previewViewer, /function openMolstarContextScopeRepresentationDialog\(target\)/);
assert.match(previewViewer, /openSceneTreeRepresentationDialog\(representationRef, target\?\.label \|\| 'Selection'\)/);
assert.match(previewViewer, /function openSceneTreeRepresentationDialog\(ref, targetLabel\)/);
assert.match(previewViewer, /sceneTreeRepresentationMenu\(body, viewer, node, target\)/);
...
assert.match(previewRuntimeCss, /\.buret-molecule-tool-dialog-layer \{/);
assert.match(previewRuntimeCss, /\.buret-molecule-tool-dialog \{/);
assert.match(previewRuntimeCss, /\.buret-molecule-tool-dialog-header \{/);
assert.match(previewRuntimeCss, /\.buret-molecule-tool-dialog-body \{/);

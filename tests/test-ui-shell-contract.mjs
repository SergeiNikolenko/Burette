...
assert.match(browserDevDocuments, /const VIEWER_ASSET_VERSION = "viewer-ui-v16"/);
...
assert.match(previewViewer, /animation\.textContent = 'Anim'/);
...
assert.match(previewRuntimeCss, /body\.buret-docking-pose-controls-active \.msp-animation-viewport-controls \{/);

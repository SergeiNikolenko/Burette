...
assert.match(styles, /\.project-group-row \{[^}]*position: relative;[^}]*padding: 5px 76px 5px 10px;[^}]*overflow: hidden;/s);
assert.match(styles, /\.project-folder-row \{[^}]*position: relative;[^}]*padding: 5px 40px 5px calc\(6px \+ \(var\(--project-depth, 0\) \* 6px\)\);[^}]*overflow: hidden;/s);

...
assert.match(browserDevDocuments, /if \(normalized === "xyzrender-external"\) return "xyzrender-external";\s*return externalMolstarAvailable \? "molstar" : "xyzrender-external";/);

...
assert.match(previewShell, /data-buret-action="undo-molstar-edit"/);
assert.match(previewShell, /aria-label="Undo last Mol\* edit"/);
...
assert.match(previewViewer, /bindMolstarEditUndoButton\(toolbar\);/);
...
assert.match(previewViewer, /updateMolstarEditUndoButton\(\);/);
assert.match(previewViewer, /function updateMolstarEditUndoButton\(\)/);
assert.match(previewViewer, /data-buret-action="undo-molstar-edit"/);
assert.match(previewViewer, /function bindMolstarEditUndoButton\(toolbar\)/);
...
assert.match(previewViewer, /if \(prepared\?\.xyzFrameMode === 'all' \|\| prepared\?\.sdfPoseMode === 'all' \|\| prepared\?\.pdbModelMode === 'all'\) \{/);

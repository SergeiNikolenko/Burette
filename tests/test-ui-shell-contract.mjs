...
assert.match(ketcherEditor, /getSdf: \(async \(\.\.\.args: Parameters<Ketcher\["getSdf"\]>\) => \(/);
...
assert.match(ketcherEditor, /getRxn: \(async \(\.\.\.args: Parameters<Ketcher\["getRxn"\]>\) => \(/);
...
assert.match(ketcherEditor, /deserializeKetcherMolfile\(MolSerializer, molfile\)/);

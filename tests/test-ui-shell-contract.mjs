...
assert.match(previewViewer, /function alignStructureSceneEntries\(prepared, mode = 'auto', options = \{\}\)/);
...
assert.match(previewViewer, /await activeStructureAlignmentControl\.setReference\(target\)/);
assert.match(previewViewer, /await activeStructureAlignmentControl\.alignTarget\(target, requestedMode\)/);
assert.match(previewViewer, /await activeStructureAlignmentControl\.alignAll\(requestedMode\)/);

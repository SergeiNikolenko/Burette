...
assert.match(pageKinds, /const kinds = \[fileKind, textFileKind, fepSetupKind, ketcherKind, launcherKind, poseReviewKind, settingsKind\] as const/);
...
assert.match(ketcherPage, /if \(\(format\?\.startsWith\("sdf-"\) \|\| !format\) && looksLikeSdfRecord\(normalized\)\)/);

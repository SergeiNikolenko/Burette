...
assert.match(previewViewer, /helper\.behaviors\.cropParams\.next\(\{ auto: false, relativePadding: 0 \}\);/);
assert.match(previewViewer, /drawMolstarPresetPreviewFrame\(item, rendered\.canvas\)/);

...
assert.match(ketcherPage, /text: "Generate Ensemble"/);
assert.match(ketcherPage, /text: "RM1 energy & charges"/);
assert.match(ketcherPage, /contentClassName="compute-command-menu"/);
assert.match(ketcherPage, /className="ketcher-compute-trigger"/);
assert.match(styles, /\.radix-menu\.compute-command-menu \{/);
assert.match(styles, /\.compute-command-menu \.radix-menu-item-copy \{[\s\S]*flex-direction: row;/);
...
assert.match(previewShell, /class="buret-toolbar-group" role="group" aria-label="Structure actions"/);
...
assert.match(previewViewer, /generate3dButton\.addEventListener\('click', event => showGenerate3DMenu\(generate3dButton, event\.detail === 0\)\)/);
assert.match(previewViewer, /function showGenerate3DMenu\(anchor, focusFirst = false\)/);
...
assert.match(previewRuntimeCss, /width: min\(288px, calc\(100vw - 16px\)\);/);
assert.match(previewRuntimeCss, /\.buret-compute-menu-separator \{/);
assert.match(previewRuntimeCss, /\.buret-toolbar-group \{/);
...
assert.doesNotMatch(previewRuntimeCss, /right: 62px;/);
assert.doesNotMatch(previewRuntimeCss, /body\.buret-molstar-viewport-panel-open \.buret-generate-3d-control \{/);
assert.match(previewViewer, /showGenerate3DMenu\(generate3dButton, event\.detail === 0\)/);
assert.match(previewViewer, /\['ArrowDown', 'ArrowUp', 'Home', 'End'\]/);
assert.match(previewViewer, /document\.documentElement\.style\.setProperty\('--buret-generate-3d-panel-top'/);
assert.match(previewRuntimeCss, /\.buret-generate-3d-control \{[\s\S]*display: inline-flex;/);

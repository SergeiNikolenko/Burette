...
assert.match(agentIntegrationPanel, /Manual setup/);
...
assert.match(styles, /\.project-group-row \{[^}]*position: relative;[^}]*color: var\(--text-secondary\);[^}]*padding: 5px 76px 5px 10px;[^}]*overflow: hidden;/s);
assert.match(styles, /\.project-group-row:hover \{\s*background: transparent;\s*box-shadow: inset 0 0 0 1px var\(--line-subtle\);\s*\}/);
...
assert.match(styles, /\.project:hover \{\s*background: transparent;\s*box-shadow: inset 0 0 0 1px var\(--line-subtle\);\s*\}/);
...
assert.match(styles, /\.project-folder-row:hover,\s*\.project-folder-row:focus-visible\s*\{\s*background: transparent;\s*box-shadow: inset 0 0 0 1px var\(--line-subtle\);\s*outline: none;\s*\}/);

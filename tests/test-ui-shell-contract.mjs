...
assert.match(previewRuntimeCss, /\.buret-molstar-preset-preview-stage \{[\s\S]*opacity: 0;/);
...
assert.match(previewViewer, /appearance\.setAttribute\('role', 'menuitemcheckbox'\)/);
assert.match(previewViewer, /separator\.setAttribute\('role', 'separator'\)/);
assert.match(previewViewer, /appearanceToggle\.getAttribute\('aria-checked'\) === 'true' \? 'default' : 'illustrative'/);
assert.match(previewViewer, /menu\.querySelectorAll\('\[role="menuitemradio"\], \[role="menuitemcheckbox"\]'\)/);
assert.match(previewRuntimeCss, /\.buret-molstar-appearance-switch \{/);
assert.match(previewRuntimeCss, /\.buret-molstar-appearance-item\[aria-checked="true"\] \.buret-molstar-appearance-switch/);
...
assert.match(previewViewer, /relativePadding: 0\.07/);
assert.match(previewViewer, /drawMolstarPresetPreviewCrop\(item, rendered\.canvas, helper\.relativeCrop\)/);
assert.match(previewViewer, /preview\.dataset\.cropAspect = \(width \/ height\)\.toFixed\(3\)/);
...
assert.doesNotMatch(previewViewer, /molstarPresetPreviewTimer/);

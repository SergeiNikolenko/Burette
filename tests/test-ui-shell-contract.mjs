...
assert.match(browserDevDocuments, /const GRID_ASSET_VERSION = "grid-ui-v54"/);
...
assert.match(fileKind, /const paths = ligandDropPathsForTarget\(document\.path, droppedPaths\)/);

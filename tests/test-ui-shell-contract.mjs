...
assert.match(previewShell, /data-buret-molstar-preset-preview role="button" tabindex="0" aria-label="Apply preset preview"/);
...
assert.match(previewRuntimeCss, /\.buret-molstar-preset-preview \{[\s\S]*?pointer-events: auto;/);

...
assert.match(previewViewer, /align\.textContent = prepared\.structureAlignmentEnabled \? 'Aligned' : 'Align'/);
...
assert.match(previewViewer, /const DOCKING_POSE_POSITION_VERSION = '5'/);
...
assert.match(previewViewer, /const top = root\.classList\.contains\('buret-docking-poses-structure-scene'\) \? 58 : 14;/);
assert.match(previewViewer, /moveDockingPoseControls\(root, bounds\.left, top, mainRect\);/);

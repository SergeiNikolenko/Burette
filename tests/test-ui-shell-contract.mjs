...
assert.match(ketcherPage, /format\.startsWith\("molfile-"\) \|\| format\.startsWith\("sdf-"\)\s*\?\s*instance\.setMolfile\(firstMolBlock\(text\)\)\s*:\s*instance\.setMolecule\(text, \{ needZoom: true \}\)/);

...
assert.match(app, /\.\.\.createJobHistoryShellActions\(\{ pushStatus, setConformerJobs, setXtbJobs \}\)/);
...
assert.match(app, /\.\.\.createProjectShellActions\(\{ pushStatus, removeProjectRoot, renameProjectRoot, togglePinnedProjectRoot \}\)/);
...
assert.match(app, /\.\.\.createDockDropShellActions\(\{ addDockDrop, pushStatus \}\)/);
...
assert.match(app, /\.\.\.createDocumentCloseShellActions\(\{/);
...
assert.match(app, /\.\.\.createRecentShellActions\(\{ clearRecentStructures, pushStatus \}\)/);
assert.match(appShellActionsHook, /pushStatus\("Recent structures cleared"\)/);
assert.match(app, /\.\.\.createUpdateShellActions\(\{ checkForUpdates, installUpdate \}\)/);

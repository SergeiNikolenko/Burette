...
assert.match(previewViewController, /resolvedXyzrenderControls = xyzrenderControlsOverride \?\? defaultXyzrenderInput\?\.controls/);
...
assert.match(previewViewController, /if \(renderer == BurreteRendererMode\.molstar \|\| PreviewStructureTextConverter\.shouldPreferConvertedMolstarData\(fileExtension: pathExtension\)\),\s*let convertedStructure = PreviewStructureTextConverter\.convertedData/s);

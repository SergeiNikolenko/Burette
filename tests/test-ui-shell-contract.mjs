...
assert.match(ketcherPage, /if \(!isBlankKetcherMolfile\(restoredMolfile\)\) return;/);
assert.doesNotMatch(ketcherPage, /if \(restoredMolfile\.trim\(\)\) return;/);
...
assert.match(ketcherPage, /disabled=\{!ketcher \|\| outputMode !== "molfile" \|\| !output\.trim\(\)\}/);

...
assert.match(previewShell, /Choose lighting and outline appearance/);
...
assert.match(previewShell, /data-buret-molstar-style aria-label="Mol\* appearance"/);
...
assert.match(previewViewer, /select\.addEventListener\('change', \(\) => requestMolstarAppearance\(select\.value\)\)/);

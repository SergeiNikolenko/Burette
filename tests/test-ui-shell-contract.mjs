...
assert.match(buretteAgentCli, /BURETTE_DEV_FS_ALLOW: browserDevFsAllowRoots\(initialFile, sceneFiles \?\? \[\]\)\.join\(delimiter\)/);
assert.match(buretteAgentCli, /BURETTE_BROWSER_DEV_GENERATED_FILES_ROOT: browserDevGeneratedFilesRoot/);
assert.match(buretteAgentCli, /\.\.\.browserDevFsAllowRoots\(initialFile, sceneFiles \?\? \[\]\)\.flatMap\(\(root\) => \['--allow', root\]\)/);
...
assert.match(bootOverlayScript, /function removeOverlay\(\) \{\s*if \(mounted\) return;\s*mounted = true;/);
...
// Native-size controls must not scale the pointer-coordinate canvas.
assert.doesNotMatch(styles, /--ketcher-chrome-scale/);
...
assert.match(styles, /:is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="Settings-module_settings"\]\s*\{[^}]*width: min\(420px, calc\(100% - 32px\)\) !important;[^}]*max-width: calc\(100% - 32px\);/s);
assert.match(styles, /Accordion-module_accordionSummary/);
assert.match(styles, /Accordion-module_accordionDetailsWrapper/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\)\s*\{[^}]*--ketcher-dark-canvas: var\(--bg-base\);[^}]*--color-background-canvas: var\(--ketcher-dark-canvas\);[^}]*background: var\(--ketcher-dark-canvas\);[^}]*color-scheme: dark;/s);
assert.match(styles, /--ketcher-dark-structure: color-mix\(in srgb, var\(--fg-base\) 90%, var\(--bg-base\)\);/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="top-toolbar"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="monomer-library"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="template-lib-module_dialog_body"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="template-lib-module_tabsContent"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="TemplateTable-module_tableContent"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="template-lib-module_tabs"\] \.MuiTab-root\.Mui-selected/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="template-lib-module_dialog_body"\] \[data-testid="close-window-button"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="template-lib-module_dialog_body"\] \[class\*="Dialog-module_closeButton"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="Settings-module_settings"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="Settings-module_settings"\] \[class\*="Accordion-module_accordionDetails"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="Settings-module_settings"\] \[class\*="Accordion-module_accordionSummaryWrapper"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="Settings-module_settings"\] \[data-testid="close-window-button"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="save-to-sdf-button"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="add-to-canvas-button"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="TemplateTable-module_struct"\] :is\(path, line, polyline, polygon, circle, ellipse, rect\)\[stroke="#000"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="ActionButton-module_button"\]:not\(\[class\*="selected"\]\)/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="StyledIconButton"\]:not\(:disabled\)/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="top-toolbar"\] button:not\(:disabled\)/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="top-toolbar"\] button svg/);
assert.match(styles, /top-toolbar"\] button:not\(:hover\):not\(:disabled\) svg[\s\S]*--ketcher-dark-muted/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="top-toolbar"\] button :is\(path, circle, rect, polygon, polyline, ellipse, use\):not\(\[fill="none"\]\)/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="top-toolbar"\] button :is\(path, circle, rect, polygon, polyline, line, ellipse, use\)\[stroke\]:not\(\[stroke="none"\]\)/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="top-toolbar"\] button:not\(:hover\):not\(:disabled\) svg :is\(path, circle, rect, polygon, polyline, ellipse\)\[fill="#fff"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="top-toolbar"\] button:not\(:hover\):not\(:disabled\) svg :is\(path, circle, rect, polygon, polyline, line, ellipse\)\[stroke="#fff"\]/);
...
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="polymer-toggler"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="right-toolbar"\] \[data-testid="H-button"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="right-toolbar"\] \[data-testid="C-button"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="StructEditor-module_canvas"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="drawn-structures"\],\s*\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \.drawn-structures\s*\{[^}]*color: var\(--ketcher-dark-structure\);/s);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="drawn-structures"\] :is\(path, line, polyline, polygon, circle, ellipse, rect\)\[stroke="#333"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \.drawn-structures :is\(path, line, polyline, polygon, circle, ellipse, rect\)\[stroke="#333333"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="drawn-structures"\] :is\(path, text, tspan\)\[fill="#333333"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \.drawn-structures :is\(path, text, tspan\)\[style\*="fill: rgb\(51, 51, 51\)"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="canvas"\] \[data-testid="bond"\]\[stroke="#000000"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="canvas"\] \[data-testid="bond"\]\[fill="#000000"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="canvas"\] :is\(text, tspan\)\[fill="#000000"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="canvas"\] :is\(text, tspan\)\[style\*="fill: rgb\(0, 0, 0\)"\]/);
...
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="EditorWrapper"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="MenuLayout"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="RNABtn"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="monomer-library"\] \[class\*="Card-Card"\]/);
assert.match(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="monomer-library"\] \[class\*="Card-Card"\]::after\s*\{[^}]*filter: saturate\(0\.72\) brightness\(0\.82\);[^}]*opacity: 0\.58;/s);
...
assert.doesNotMatch(styles, /:is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) svg\s*\{[^}]*background-color: #f5f5f5;/s);
...
assert.doesNotMatch(styles, /:is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="App-module_top"\],\s*:is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="App-module_bottom"\],\s*:is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="top-toolbar"\],\s*:is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[data-testid="bottom-toolbar"\]\s*\{[^}]*min-width: 100%;/s);
assert.doesNotMatch(styles, /\.app-shell\[data-effective-theme="dark"\] :is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) [^{]*\{[^}]*\b(width|height|min-width|min-height|max-width|max-height|transform|zoom):/s);
...
// The canvas retains upstream dimensions and pointer coordinates.
assert.equal((styles.match(/\[class\*="App-module_canvas"\]/g) ?? []).length, 0);
assert.doesNotMatch(styles, /\[class\*="BottomToolbar-module_root"\]/);
assert.doesNotMatch(styles, /\.ketcher-empty-watermark\s*\{/);
assert.doesNotMatch(styles, /:is\(\.ketcher-editor-shell, \.ketcher-ui-dialog\) \[class\*="StructEditor-module_canvas"\] svg path\s*\{[^}]*fill: transparent;/s);
...
assert.match(appGenerate3DConformerHook, /native CPU.*and opened the artifact in Molstar/);
...
assert.match(dockPanel, /StoryMarkdown text=\{story\.summary\}/);
...
assert.match(dockPanel, /data-ketcher-dock-portal="right"/);
...
assert.match(ketcherPage, /<p>\{hasSketch \? "Molecular structure" : "Draw or import a structure"\}<\/p>/);
...
assert.match(await source("apps/desktop/src/components/dock-file-tabs.tsx"), /actions\.setDockDocument\(area, entry\.documentId\)/);
assert.match(await source("apps/desktop/src/components/dock-file-tabs.tsx"), /actions\.setDockTool\(area, "ketcher"\)/);
...
assert.match(previewViewer, /type: 'exportText',\s*requestId,\s*name: payload\.name,\s*mimeType: payload\.mimeType,\s*text: payload\.text/s);
...
for (const runtimeSource of [previewViewer]) {
  ...
  assert.match(runtimeSource, /structures => applyXyzFrameMolstarStyle\(viewer, foregroundStyle, structures, 1, 'colored'\)/);
...
assert.match(previewViewer, /await switchCachedPoseLayer\(viewer, state, activeIndex,/);
...
assert.match(appGridConformerMessagesHook, /updateGridJob\(\{ durableJobId: job\.jobId, cancelable: true, progress \}\)/);
...
assert.match(ketcherPage, /isActive && panelMode && dockPortalElement \? createPortal/);
assert.match(ketcherPage, /actions\.setDockTool\("right", "ketcher"\)/);

...
assert.doesNotMatch(previewViewer, /function molstarMoleculePreviewSVG\(entry\)/);
assert.doesNotMatch(previewViewer, /buret-molstar-molecule-preview-bonds/);
assert.doesNotMatch(previewViewer, /buret-molstar-molecule-preview-atoms/);
...
assert.match(previewViewer, /window\.BurreteConfig\?\.rdkitWasmPath \|\| 'rdkit\/RDKit_minimal\.wasm'/);

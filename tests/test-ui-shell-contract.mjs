...
assert.match(structureInfoPanel, /const textPromise = virtualText === null[\s\S]*readStructureText\(document\.path, \{ maxBytes: compositionReadLimit\(document\) \}\)[\s\S]*Promise\.resolve\(virtualText\);/);
...
assert.match(browserDevDocuments, /const VIEWER_ASSET_VERSION = "viewer-ui-v40"/);

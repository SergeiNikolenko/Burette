...
assert.match(settingsPanel, /preferenceRow<"rendererMode">\("Mode", "Choose the renderer used for newly opened structures\.", preferences\.rendererMode, defaultRendererModeOptions, defaultPreferences\.rendererMode/);
...
assert.match(commandPalette, /Search Open Structures/);

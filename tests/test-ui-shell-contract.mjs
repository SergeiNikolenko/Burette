...
assert.match(sidebarFileBrowser, /className="sidebar-browser-title">Burrete<\/strong>/);
...
assert.match(previewViewer, /moveDockingPoseControls\(root, rect\.left, rect\.top, mainRect, true\)/);
assert.match(previewViewer, /moveDockingPoseControls\(root, event\.clientX - drag\.dx, event\.clientY - drag\.dy, undefined, true\)/);
...
assert.match(previewViewer, /root\.dataset\.defaultPosition = '0';\s*moveDockingPoseControls\(root, event\.clientX - drag\.dx, event\.clientY - drag\.dy, undefined, true\);/);

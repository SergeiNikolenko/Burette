...
assert.match(ketcherPage, /title=\{ketcherThemeTitle\}/);
...
assert.match(ketcherPage, />\s*Copy\s*<\/button>/);
assert.match(ketcherPage, />\s*Save\s*<\/button>/);
assert.match(ketcherPage, />\s*Open raw\s*<\/button>/);
...
assert.match(browserDevDocuments, /const VIEWER_ASSET_VERSION = "viewer-ui-v65"/);

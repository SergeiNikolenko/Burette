...
assert.match(previewViewer, /reason: 'preset-preview',[\s\S]*radiusScale: 0\.72/);
...
assert.match(previewViewer, /const appearance = option\.defaultAppearance \|\| configuredMolstarAppearance/);

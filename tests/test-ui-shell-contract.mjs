...
assert.match(appGenerate3DConformerHook, /result\.backend === "nativeMetal" \? "Metal GPU" : "CPU reference fallback"/);
...
assert.match(appGenerate3DConformerHook, /`Generating \$\{conformerGenerationTaskLabel\(mode\)\} with \$\{preferences\.conformerEngine\.toUpperCase\(\)\}\.\.\.`/);
...
assert.match(previewRuntimeCss, /--buret-menu-background: rgb\(248, 248, 246\);/);

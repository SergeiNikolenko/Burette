...
assert.match(ketcherPage, /const \[collectionChooserOpen, setCollectionChooserOpen\] = useState\(false\)/);
assert.match(ketcherPage, /className="ketcher-collection-menu-anchor"/);
assert.match(ketcherPage, /aria-haspopup="menu"/);
assert.match(ketcherPage, /className="ketcher-collection-menu" role="menu" aria-label="Collection target"/);

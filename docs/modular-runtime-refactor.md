...
- `App.tsx` still owns xTB/conformer controller state, the Molstar in-place
  replacement sender, grouped ShellActions assembly, and the top-level
  viewer/grid message bus dispatch. These are the remaining high-risk slices

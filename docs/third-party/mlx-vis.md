...
Burette's native dimensionality-reduction implementation adapts algorithmic
...
with the upstream author by the Burette product owner.

Production Burette does not bundle Python, NumPy, or MLX. The relevant
...
is not used in this first product surface because Burette already computes an

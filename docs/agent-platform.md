...
separator, slider and colours entries, an optional logical window position and an
optional session string. It returns a selected ID or cancellation; callbacks remain
